...
class RequestPolicy
{
    ...
    {
        return $user->hasPermission('request.update');
    }
    ...
    {
        return $user->hasPermission('request.delete');
    }
    ...
    {
        return $user->hasPermission('request.restore');
    }
    ...
    {
        return $user->hasPermission('request.delete.force');
    }
}
